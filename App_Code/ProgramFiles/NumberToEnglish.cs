...
public class NumberToEnglish
{
    ...
    {
        String val = "";
        //wholeNo = numb, points = "", andStr = "", pointStr = "";
        ...
        NumberToEnglish w = new NumberToEnglish();
        string num1 = numb;

        string[] decimalPlace = num1.Split('.');
        long a = Convert.ToInt64(decimalPlace[0]);
        long b = 0;
        try
        {
            b = Convert.ToInt64(decimalPlace[1]);
        }
        catch
        {
            b = 0;
        }
        string inword1 = w.convert(a);
        string inword2 = w.convert(b);

        string inwords = "";
        if (inword2.Trim().Length > 0)
        {
            inwords = inword1.Trim() + " and " + inword2 + " Paise";
        }
        else
        {
            inwords = inword1;

                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>&#8377; <%=inventory.TempRs["dueamt"] %></td>
                                    </tr>
                                    <tr>
                                        <th style="text-align:right">Amount to be Paid:</th>
                                        <td>&#8377; <%=Convert.ToDecimal(inventory.TempRs["total_amt"].ToString())-Convert.ToDecimal(inventory.TempRs["dueamt"].ToString()) %></td>
                                    </tr>
                                </table>
                            </div>
                        </div>

    ...
    function getDetByQty(e) {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                var whole_qty = parseFloat($("#item_qty").val()) * parseFloat(data.def_unit);
                $("#stkitem_qty").val(whole_qty).change();
                if(x==y)
                {
    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Purchase & Stock Entry</h3>
                <div class="box-tools pull-right">
                    <a href="purvoucher_list.aspx?cmd=Clear" class="btn btn-primary"><i class="fa fa-fw fa-long-arrow-left"></i>Go To List</a>
                </div>
            </div>
                        ...
                        <div class="col-md-7 col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-7">
                                    <input type="text" name="invoice_no" id="invoice_no" <%=disableonpay %> value="<%=inventory.TempRs["invoice_no"]!=""?inventory.TempRs["invoice_no"]:"" %>" required class="form-control input-sm" onkeyup="this.value=this.value.toUpperCase()" />
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3 col-sm-7">
                                        <div class="col-md-12 col-sm-12 input-group">
                                            ...
                                            <input type="number" name="round_off" id="round_off" <%=disableonpay %> value="<%=inventory.TempRs["round_off"]!=""?inventory.TempRs["round_off"]:roundoff.ToString("0.00") %>" required class="form-control input-sm" readonly onchange="calculateinvoice()" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-7">
                                        <div class="col-md-12 col-sm-12 input-group">
                                            ...
                                            <input type="number" name="total_amt" id="total_amt" <%=disableonpay %> required class="form-control input-sm" value="<%=totalprice.ToString("0.00") %>" readonly />
                                        </div>
                                    </div>
                                </div>

        ...
        <div class="box box-default">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="purchaseret_list.aspx?cmd=Clear" class="btn btn-primary"><i class="fa fa-fw fa-long-arrow-left"></i>Back</a>
                </div>
            </div>
            <%inventory.Execute();
                if(inventory.TempRs["invoice_type"]=="P")
                {
                    Response.Redirect("purvoucher_print.aspx?uid="+ inventory.MD5(inventory.TempRs["id"]) +"&wid=eccbc87e4b5ce2fe28308fd9f2a7baf3");
                }

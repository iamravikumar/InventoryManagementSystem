                ...
                <div class="box-body">
                    <div id="printableArea">
                        <table class="table table-bordered" id="testTable" rules="groups">
                            <tr>
                                <td colspan="11" style="text-align: center; font-size: 27px; font-weight: bold">Daybook</td>
                            </tr>
                            <tr>
                            ...
                            <%
                                ...
                                string whereClause = " company_id='" + where[2] + "' and invoice_dt>='"+DateTime.ParseExact(where[0], "dd-MM-yyyy", null).ToString("MM-dd-yyyy")+"' and invoice_dt<='"+DateTime.ParseExact(where[1], "dd-MM-yyyy", null).ToString("MM-dd-yyyy")+"' ";

                                SqlDataReader rdr = inventory.GetDataReader("select id,invoice_no,invoice_dt,ladgername,ledgercode, total_amt, dueamt from view_inventory_master where " + whereClause + " order by id asc");
                                ...
                                tcr+=Convert.ToDecimal(rdr["total_amt"]);
                                tdr+=Convert.ToDecimal(rdr["dueamt"]);
                            %>
                            <tr>
                                <td><%=++i %></td>
                            ...
                            <tr style="text-align:right;font-weight:bold">
                                ...
                                <td>&#8377; <%=tcr.ToString("0.00")%></td>
                                <td>&#8377; <%=tdr.ToString("0.00")%></td>
                            </tr>
                             <%   } else{ %>
                            <tr>

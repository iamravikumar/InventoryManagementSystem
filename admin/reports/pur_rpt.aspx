                ...
                <div class="box-body">
                    <div id="printableArea">
                        <table class="table table-bordered" id="testTable" rules="groups">
                            <tr>
                                <td colspan="11" style="text-align: center; font-size: 27px; font-weight: bold">Purchase</td>
                            </tr>
                            <tr>
                            ...
                            <%
                                ...
                                string whereClause = "invoice_type='P' and company_id='" + where[2] + "' and invoice_dt>='"+DateTime.ParseExact(where[0], "dd-MM-yyyy", null).ToString("MM-dd-yyyy")+"' and invoice_dt<='"+DateTime.ParseExact(where[1], "dd-MM-yyyy", null).ToString("MM-dd-yyyy")+"' ";
